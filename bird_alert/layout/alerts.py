...
class Alerts():
    ...
    def __parse_date(spotted_bird):
        ...
        return "{}|{}|{}".format(time_of_spot.day,
                                time_of_spot.month,
                                str(time_of_spot.year)[2:]
        )
    ...
    def set_alerts(self, matrix, pos, spotted_bird):
        ...
        #type of bird
        bird_length = graphics.DrawText(matrix, font, pos, 20, graphics.Color(255, 255, 255), spotted_bird.bird_name)

        #location
        bird_loc = graphics.DrawText(matrix, font, pos, 30, textColor, spotted_bird.bird_loc)
